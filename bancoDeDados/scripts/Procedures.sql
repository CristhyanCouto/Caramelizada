...
--FILMES_BY_GENERO--
/*MESMA COISA DO FILMES_MINHA_NOTA, MAS COM O PARÂMETRO DE GENERO*/

DELIMITER $

CREATE PROCEDURE filmes_by_genero(GENEROPARAMETRO VARCHAR(100))
    BEGIN
        SELECT
            F.IDFILME AS "ID",
            F.NOME_FILME AS "Nome do Filme",
...
--JOGOS_BY_GENERO--
/*ESSA FUNÇÃO CHAMA OS JOGOS PELO GENERO ESCOLHIDO PASSANDO O NOME DO GENERO
COMO PARÂMETRO*/

DELIMITER $

CREATE PROCEDURE jogos_by_genero(GENERO_PARAMETRO VARCHAR(100))
    BEGIN
        SELECT
            J.IDJOGO AS "ID",
            J.NOME_JOGO AS "Nome do Jogo",
